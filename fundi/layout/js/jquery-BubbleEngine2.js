  ...
  $.fn.extend({
    BubbleEngine: function(options) {
      var defaults = {
        particleSizeMin:            0,
        particleSizeMax:            60,
        particleSourceX:            5000,
        particleSourceY:            5000,
        particleAnimationDuration:  3000,
        particleAnimationVariance:  2000,
        particleScatteringX:        5000,
        particleScatteringY:        2000,
...
function random_prize(el){
	...
	if( no_clicks > 0 ){
		...
		if(has_clicked == '0'){
			...
			if(random_prize == 0){
				random_prize1 = getRandomInt(0, 10000);
			}else if(random_prize == 1){
				random_prize2 = getRandomInt(0, 1);
			}else if(random_prize == 2){
				random_prize3 = getRandomInt(0, 50);
			}else if(random_prize == 3){
				random_prize4 = getRandomInt(0, 25);
			}
