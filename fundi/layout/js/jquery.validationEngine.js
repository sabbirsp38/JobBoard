    ...
    var methods = {
        ...
        hide: function() {
        	if(jQuery(this).is("form")){
        		 var closingtag = "parentForm"+jQuery(this).attr('id');
        	}else{
        		
        		var closingtag = jQuery(this).attr('id') +"formError"
        	}
        ...
        _equals: function(field, rules, i, options) {
            ...
            if (field.attr('value') != jQuery("#" + equalsField).attr('value'))
        ...
        _calculatePosition: function(field, promptElmt, options) {
            ...
            switch (options.promptPosition) {
                ...
                case "topRight":
                    if (overflow)
                        // Is the form contained in an overflown container?
                        promptleftPosition += fieldWidth - 300;
                    else {
                        promptleftPosition += fieldWidth - 300;
                    ...
                    break;
                case "topLeft":
                    promptTopPosition += -promptHeight - 100;
                    break;
                case "centerRight":
                    promptleftPosition += fieldWidth + 103;
                    break;
                case "bottomLeft":
                    promptTopPosition = promptTopPosition + field.height() + 105;
                    break;
                case "bottomRight":
                    promptleftPosition += fieldWidth - 300;
                    promptTopPosition += field.height() + 50;
            }
