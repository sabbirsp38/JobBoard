                ...
                <div class="job-view-controller-wrapper">
                  ...
                  ?>
                       <?php
                        ...
                        if(isset($_POST['job-type']) && addslashes ($_POST['job-type'])!= null)
                        $from_data1 =addslashes ($_POST['job-type']);
                        if(isset($_POST['location']) && addslashes ($_POST['location'])!= null)
                        $from_data2 = addslashes ($_POST['location']);
                        if(isset($_POST['category']) && addslashes ($_POST['category'])!= null)
                        $from_data3 = addslashes ($_POST['category']);
                        if(isset($_POST['experience']))
                        $from_data4 = addslashes ($_POST['experience']);
                        if(isset($_POST['post']))
                        $from_data5 = addslashes ($_POST['post']);
                        if(isset($_POST['gender']))
                        $from_data6 = addslashes ($_POST['gender']);
                        if(isset($_POST['qualification']))
                        $from_data7 = addslashes ($_POST['qualification']);
                        if(isset($_POST['start_from1']))
                        $from_data8 = addslashes ($_POST['start_from1']);
                        if(isset($_POST['end-from']))
                        $from_data9 = addslashes ($_POST['end-from']);
                           ...
                           $query .= " category ='$from_data3'";
                           }
                           if($from_data2!='Location'){
                           $query .= "and location ='$from_data2'";
                           }
                           if(isset($from_data1)){
                           $query .= "and type ='$from_data1'";
                           }
                           if(isset($from_data4)){
                           $query .= "and experience ='$from_data4'";
                           }
                           if(isset($from_data6)){
                           $query .= "and gender ='$from_data6'";
                           }
                           if(isset($from_data7)){
                           $query .= "and qualification ='$from_data7'";
                           }
                           if($from_data8!=0){
                           $query .= "and sel_range_s <= '$from_data8' ";
                           }
                           if($from_data9!=6130){
                           $query .= "and sel_range_e >='$from_data9'";
                           }
...
<!--paginetation-->
              ...
              <div class="job-filter-wrapper">
                <form action="job-listing_filter.php" method="post" id="selectpicker1" name="selectpicker1">
                  ...
                  <div class="price-range-slider">
                    <div class="nstSlider" data-range_min="0" data-range_max="10000" 
                     data-cur_min="0"    data-cur_max="6130">
                      ...
                      <input type="hidden"  name="start_from1" id="leftLabel1"><br>
                      <input type="hidden" name="end-from" id="rightLabel1">
                    </div>
                  </div>
                </div>
...
<script type="text/javascript">
    ...
    document.getElementById('selectpicker1').onsubmit = function (){
      var x = document.forms["selectpicker1"]["category"].value;
      var submit = true;
      if (x == "Category" || x == "") {
        alert("You must Select Category");
       document.location = 'job-listing.php';
        submit = false;
    }
    return submit;
