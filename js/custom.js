...
$(document).ready(function() {
    ...
    $('.job-filter a, .candidate-filter a, .employer-filter a').on('click', function(e) {
      ...
      var innerContent = '<a href="#">' + $(this).data("attr") + '<input type="hidden" name="'+cls+'" value="' + $(this).data("attr") + '"></a><span class="ti-close"></span>';
    ...
    function priceRange() {
      $('.nstSlider').nstSlider({
        ...
        "value_changed_callback": function (cause, leftValue, rightValue) {
          ...
          var start1 =  leftValue;
           document.getElementById('leftLabel1').value = start1;   
            var start2 =  rightValue;
           document.getElementById('rightLabel1').value = start2;   
