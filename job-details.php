          ...
          <div class="col">
            <div class="job-listing-details">
              <div class="job-title-and-info">
                ...
                <div class="buttons">
                  <a class="apply" href="applyjob.php? $job_uid=<?php echo $result['job_uid']; ?>">Apply Online</a>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-xl-7 col-lg-8">
                    ...
                    <div class="job-apply-buttons">
                      <a href="applyjob.php? $job_uid=<?php echo $result['job_uid']; ?>" class="apply">Apply Online</a>
                    </div>
                  </div>
                    ...
                    <div class="information-and-share">
                      <div class="job-summary">
                        ...
                        <ul>
                          ...
                          <li><span>Salary Start:</span><?php echo $result['sel_range_s']; ?></li>
                          <li><span>Salary End:</span><?php echo $result['sel_range_e']; ?></li>
